...
public class AuthController {
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = UserDataSchema.class)) }, description = "User berhasil terdaftar"),
                        @ApiResponse(responseCode = "400", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Kesalahan dalam request, lihat message untuk rincian")
        })
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = LoginSuccess.class)) }, description = "Access token sudah terbuat"),
                        @ApiResponse(responseCode = "400", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Kesalahan dalam request, lihat message untuk rincian"),
                        @ApiResponse(responseCode = "404", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Email tidak terdaftar")
        })
        @PostMapping("login")
        ...
        public ResponseEntity<?> loginWithGoogle(@RequestParam MultiValueMap<String, String> parameters)
                        throws IOException {
                return ResponseEntity.ok(
                                BaseResponse.success(authService.signWithGoogle(parameters), "Success Sign Google"));
        }
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = StringDataSchema.class)) }, description = "OTP terkirim"),
                        @ApiResponse(responseCode = "400", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Kesalahan dalam request, lihat message untuk rincian"),
                        @ApiResponse(responseCode = "404", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Email tidak terdaftar")
        ...
        public ResponseEntity<?> sendEmailOtp(@RequestBody EmailRequest req) {
                return ResponseEntity.ok(
                                BaseResponse.success(authService.sendEmailOtp(req, "Register"), "Success Send OTP"));
        }

        @Operation(summary = "Aktivasi user", description = "Masukkan otp untuk aktivasi user")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = StringDataSchema.class)) }, description = "User aktif"),
                        @ApiResponse(responseCode = "400", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Kesalahan dalam request, lihat message untuk rincian"),
                        @ApiResponse(responseCode = "404", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "OTP tidak terdaftar")
        })
        ...
        public ResponseEntity<?> sendEmailForgetPassword(@RequestBody EmailRequest req) {
                return ResponseEntity.ok(BaseResponse.success(authService.sendEmailOtp(req, "Forget Password"),
                                "Success Send OTP Forget Password"));
        }

        @Operation(summary = "Cek apakah otp valid")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = StringDataSchema.class)) }, description = "OTP valid"),
                        @ApiResponse(responseCode = "400", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Kesalahan dalam request, lihat message untuk rincian"),
                        @ApiResponse(responseCode = "404", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "OTP tidak terdaftar")
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = StringDataSchema.class)) }, description = "Berhasil reset password"),
                        @ApiResponse(responseCode = "400", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = NullDataSchema.class)) }, description = "Kesalahan dalam request, lihat message untuk rincian"),
        })
        @PutMapping("password")
        public ResponseEntity<?> changePassword(@RequestBody ResetPasswordRequest request) {
                return ResponseEntity
                                .ok(BaseResponse.success(authService.resetPassword(request), "Success Reset Password"));
        }
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = UserDataSchema.class)) }, description = "Berhasil mengambil data user yang terautentikasi"),
                        @ApiResponse(responseCode = "401", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorSchema.class)) }, description = "Access token salah")
        })
        @GetMapping
        public ResponseEntity<?> getCurrentUser(Principal principal) {
                return ResponseEntity.ok(BaseResponse.success(authService.getCurrentUser(principal),
                                "Success Get Current User Login"));
        }
